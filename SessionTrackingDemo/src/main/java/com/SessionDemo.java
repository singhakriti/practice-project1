...
public class SessionDemo extends HttpServlet {
	...
	pw.println("</br> Session creation time in milisecond"+hs.getCreationTime());
	pw.println("</br> Session creation time and Date"+new Date(hs.getCreationTime()));
	pw.println("</br> Session Last Access time"+new Date(hs.getLastAccessedTime()));
	pw.println("</br> Default Access time"+hs.getMaxInactiveInterval());
