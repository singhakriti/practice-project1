...
public class TrainerDao {
	...
	//update record
//		public int updateTrainer(int trainerId, String Tname) {
//			SessionFactory sf=HibernateResource.getSessionFactory();
//			Session session = sf.openSession();
//			Transaction tran=session.getTransaction();
//			Trainer t1=session.find(Trainer.class,trainerId);
//			if(t1==null) {
//				return 0;
//				}else {
//					tran.begin();
...
//		
	...
	public List<Object[]> findAllTrainerIdAndName(){
		...
		List<Object[]> trainerIdAndName=tq.getResultList();
		return trainerIdAndName;	
	}
